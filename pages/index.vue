  ...
  <div class="home">
    ...
    <div class="container movies">
      <div id="movie-grid" class="movies-grid">
        <div v-for="(movie, index) in (searchInput !== '' ? searchedMovies : movies)" :key="index" class="movie">
          <div class="movie-img">
...
export default Vue.extend({
  ...
  methods: {
    ...
    async searchMovies() {
      const data = await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=37ed43a4f8eaa2abd75f9283692947bc&language=en-US&page=1&query=${this.searchInput}`)
